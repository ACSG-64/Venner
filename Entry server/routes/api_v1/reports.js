...
router.get('/reports/retreive_reps/:user_id', function (req, res) {
...
router.get('/reports/retreive_rep/:user_id/:df_id', function (req, res) {
...
router.get('/reports/create_rep/:df_id/:user_id', function (req, res) {
...
router.put('/reports/delete_rep/:df_id/:user_id', function (req, res) {
